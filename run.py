...
import sys
import time
from functions import Polynomial, Constant, sin, cos
...
def evaluate(f1, f2, min_x: float, max_x: float = None, delta: float = None):
    ...
    plt.plot(x_1, l1, label="f(x)") # for this example, you'll need to configure the matplotlib window to use sensible y-axis marks
...
print(f"It took {t2 - t1} seconds to compute the taylor polynomial.")
